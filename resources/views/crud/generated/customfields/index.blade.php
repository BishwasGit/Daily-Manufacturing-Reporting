...
<th class="tb-col"><span class="overline-title">{{ label("customfield_for") }}</span></th>
<th class="tb-col"><span class="overline-title">{{ label("customfield_forref") }}</span></th>
...
<th class="tb-col"><span class="overline-title">{{ label("fa_icon") }}</span></th>
...
<th class="tb-col" data-sortable="false"><span
    ...
    <tbody>
        ...
        <tr data-id="{{$item->customfield_id}}" data-display_order="{{$item->display_order}}" class="draggable-row">
            <td class="tb-col">{{ $i++ }}</td><td class="tb-col">{{ $item->customfield_for }}</td>
<td class="tb-col">{{ $item->customfield_forref }}</td>

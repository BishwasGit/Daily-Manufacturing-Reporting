@extends('backend.template')
        ...
        <h2 class="">{{ label('Add Deductions') }}</h2>
        <?php createButton("btn-primary btn-cancel","","Cancel",route('dmr.deductions.index')); ?>

        </div>
        <div class='card-body'>
                <form action="{{route('dmr.deductions.store')}}" id="storeCustomForm" method="POST">
 @csrf 
<div class="row"><div class="col-lg-6">{{createText("deduction_amount","deduction_amount","Deduction Amount")}}

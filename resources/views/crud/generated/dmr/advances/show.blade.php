@extends('backend.template')
        ...
        <div class='card'>
            ...
            <?php createButton("btn-primary btn-cancel","","Back to List",route('dmr.advances.index')); ?>
            ...
            <div class='card-body'>
                ...
                <p><b>Advance Amount :&nbsp;&nbsp;&nbsp;&nbsp;</b> <span>{{$data->advance_amount}}</span></p><p><b>Deduction To :&nbsp;&nbsp;&nbsp;&nbsp;</b> <span>{{$data->deduction_to}}</span></p><p><b>Deduction From :&nbsp;&nbsp;&nbsp;&nbsp;</b> <span>{{$data->deduction_from}}</span></p><p><b>Status :&nbsp;&nbsp;&nbsp;&nbsp;</b> <span

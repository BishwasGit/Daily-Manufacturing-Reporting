@extends('backend.template')
        ...
        <h2 class="">{{ label('Add Processes') }}</h2>
        <?php createButton("btn-primary btn-cancel","","Cancel",route('dmr.processes.index')); ?>

        </div>
        <div class='card-body'>
                <form action="{{route('dmr.processes.store')}}" id="storeCustomForm" method="POST">
 @csrf 
<div class="row"><div class="col-lg-6">{{createText("process_name","process_name","Process Name")}}

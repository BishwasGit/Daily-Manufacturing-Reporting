@extends('backend.template')
        ...
        <div class='card'>
            ...
            <?php createButton("btn-primary btn-cancel","","Back to List",route('dmr.items.index')); ?>
            ...
            <div class='card-body'>
                ...
                <p><b>Item Name :&nbsp;&nbsp;&nbsp;&nbsp;</b> <span>{{$data->item_name}}</span></p><p><b>Wip :&nbsp;&nbsp;&nbsp;&nbsp;</b> <span>{{$data->wip}}</span></p><p><b>Status :&nbsp;&nbsp;&nbsp;&nbsp;</b> <span

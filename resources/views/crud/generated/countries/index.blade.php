...
<th class="tb-col"><span class="overline-title">{{ label("image_thumb") }}</span></th>
<th class="tb-col" data-sortable="false"><span
    ...
    <tbody>
        ...
        <tr data-id="{{$item->country_id}}" data-display_order="{{$item->display_order}}" class="draggable-row">
